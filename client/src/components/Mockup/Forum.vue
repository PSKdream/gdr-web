      ...
      <div class="main-body p-0">
        <div class="inner-wrapper">
          ...
          <div class="inner-sidebar">
            ...
            <!-- Inner sidebar body -->
            <div class="inner-sidebar-body p-0" style="overflow: hidden">
          ...
          <div class="inner-main">
            ...
            <div class="inner-main-header d-flex justify-content-between">
              ...
              <select class="form-select custom-select custom-select-sm w-auto mr-1">
            ...
            <div class="inner-main-body p-2 p-sm-3 collapse forum-content show">
              ...
              <ul
                class="
                  pagination pagination-sm pagination-circle
